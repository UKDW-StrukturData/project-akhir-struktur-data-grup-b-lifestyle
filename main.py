...
if st.button("📌 Simpan & Analisis"):
    ...
    # ======================
    # Nutrisi makanan indonesia
    # ======================
    if nutrisi_makanan and "name" in nutrisi_makanan:
        st.write("### 🍽️ Nutrisi Makanan Khas Indonesia")
        ...
        st.warning("⚠️ Nutrisi tidak ditemukan.")
